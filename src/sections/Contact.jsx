          ...
          <div className="contact-info-col">
            ...
            <div className="info-cards-list">
              <div className="info-row-card glass-card">
                ...
                <div className="info-card-text">
                  <h4>Our Location</h4>
                  <p>12, College Street, opposite Presidency Gate, Kolkata, WB 700073</p>
                </div>
              </div>
              ...
              <div className="info-row-card glass-card">
                ...
                <div className="info-card-text">
                  <h4>Phone & Call</h4>
                  <p>+91 98765 43210 (Store) <br />+91 98765 43211 (Xerox Desk)</p>
                </div>
              </div>
            ...
            <div className="mock-map-card glass-card">
              <div className="map-graphic-bg">
                ...
                {/* Simulated Landmarks */}
                <div className="map-landmark university">Presidency University</div>
                <div className="map-landmark metro">M.G. Road Metro</div>
                
                {/* Blinking Pin */}
                <div className="map-pin-wrapper">
                  <div className="map-pin-dot"></div>
                  <div className="map-pin-pulse"></div>
                  <span className="map-pin-label">Ink & Pages Store</span>
                </div>
              </div>
